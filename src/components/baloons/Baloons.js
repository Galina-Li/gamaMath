...
//             const delay = (min, max) => {return Math.floor(Math.random() * (max - min)) + min};(100, 1000)
//             const x = (min, max) => {return Math.floor(Math.random() * (max - min)) + min;};(-99, -30) // random x value to fly
//             const y = (min, max) => {return Math.floor(Math.random() * (max - min)) + min;};(-99, -30); // random y value to fly
